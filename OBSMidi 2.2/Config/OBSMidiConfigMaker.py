...
Fader1 = PushButton(PAD, text="1", grid=[0, 0, 1, 2], command=lambda:Open_FC(int(Fader1.text)), width=2, height=1)
Fader2 = PushButton(PAD, text="2", grid=[1, 0, 1, 2], command=lambda:Open_FC(int(Fader2.text)), width=2, height=1)
Fader3 = PushButton(PAD, text="3", grid=[2, 0, 1, 2], command=lambda:Open_FC(int(Fader3.text)), width=2, height=1)
Fader4 = PushButton(PAD, text="4", grid=[3, 0, 1, 2], command=lambda:Open_FC(int(Fader4.text)), width=2, height=1)
Fader5 = PushButton(PAD, text="5", grid=[4, 0, 1, 2], command=lambda:Open_FC(int(Fader5.text)), width=2, height=1)
Fader6 = PushButton(PAD, text="6", grid=[5, 0, 1, 2], command=lambda:Open_FC(int(Fader6.text)), width=2, height=1)
Fader7 = PushButton(PAD, text="7", grid=[6, 0, 1, 2], command=lambda:Open_FC(int(Fader7.text)), width=2, height=1)
Fader8 = PushButton(PAD, text="8", grid=[7, 0, 1, 2], command=lambda:Open_FC(int(Fader8.text)), width=2, height=1)
Fader9 = PushButton(PAD, text="", grid=[8, 0, 1, 6], command=lambda:Open_FC(int(Fader9.text)), width=2, height=7)
Fader1.hide()
Fader2.hide()
Fader3.hide()
Fader4.hide()
...
Button0 = PushButton(PAD, text="0", grid=[0, 0, 1, 2], command=lambda:Open_BC(int(Button0.text)), width=2, height=1)
Button1 = PushButton(PAD, text="1", grid=[1, 0, 1, 2], command=lambda:Open_BC(int(Button1.text)), width=2, height=1)
Button2 = PushButton(PAD, text="2", grid=[2, 0, 1, 2], command=lambda:Open_BC(int(Button2.text)), width=2, height=1)
Button3 = PushButton(PAD, text="3", grid=[3, 0, 1, 2], command=lambda:Open_BC(int(Button3.text)), width=2, height=1)
Button4 = PushButton(PAD, text="4", grid=[4, 0, 1, 2], command=lambda:Open_BC(int(Button4.text)), width=2, height=1)
Button5 = PushButton(PAD, text="5", grid=[5, 0, 1, 2], command=lambda:Open_BC(int(Button5.text)), width=2, height=1)
Button6 = PushButton(PAD, text="6", grid=[6, 0, 1, 2], command=lambda:Open_BC(int(Button6.text)), width=2, height=1)
Button7 = PushButton(PAD, text="7", grid=[7, 0, 1, 2], command=lambda:Open_BC(int(Button7.text)), width=2, height=1)
Button8 = PushButton(PAD, text="8", grid=[0, 2, 1, 2], command=lambda:Open_BC(int(Button8.text)), width=2, height=1)
Button9 = PushButton(PAD, text="9", grid=[1, 2, 1, 2], command=lambda:Open_BC(int(Button9.text)), width=2, height=1)
